...
function defaultState(){
  return {v:2,
    settings:{server:'europe',city:'Martlock',homeCity:'Martlock',tier:4,enchant:0,premium:true,sellMethod:'instant',returnRate:15,sortMode:'total',craftableOnly:false,
      ledgerTab:'Weapons', invTab:'Resources', invTier:4, invEnch:0,
      flipCat:'Resources', flipTier:'all', flipEnch:0, flipMode:'instant', flipMinProfit:0},
